...
class ProductsPageLocators(object):
    ...
    UPLOADED_IMAGE1_CHECKBOX = (By.XPATH, "//input[@value='catalog/1.png']")
    UPLOADED_IMAGE2_CHECKBOX = (By.XPATH, "//input[@value='catalog/2.png']")
    UPLOADED_IMAGE3_CHECKBOX = (By.XPATH, "//input[@value='catalog/3.png']")
    UPLOADED_IMAGE_DELETE_BUTTON = (By.XPATH, "//button[@data-original-title='Delete']")
    IMAGES_CLOSE = (By.CLASS_NAME, "close")
    # common locators
