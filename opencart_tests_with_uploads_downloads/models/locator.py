...
class ProductsPageLocators(object):
    ...
    IMAGE_MANAGER = (By.ID, "modal-content")
...
class DownloadsPageLocators(object):
    ...
    ADD_DOWNLOAD_FILE_BUTTON = (By.XPATH, "//a[@data-original-title='Add New']")
    INPUT_NEW_FILE_NAME = (By.XPATH, "//input[@placeholder='Download Name']")
    INPUT_NEW_FILE_MASK = (By.XPATH, "//input[@placeholder='Mask']")
    NEW_FILE_UPLOAD_BUTTON = (By.ID, "button-upload")
    INPUT_NEW_FILE = (By.ID, "input-filename")